...
# printDatabase()
letters = generateLetters(7, frequenciesFR)
print(letters)
startTime = time.time()
V1 = loadAndFilterWords("puzzles.db", "FR", letters, 99, 3)
print("Time taken for V1 filter words: ", time.time() - startTime, "seconds")
print(V1)
print(generatePuzzle(LDimensions, V1))